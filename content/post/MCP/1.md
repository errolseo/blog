...
categories:
- MCP
thumbnailImage: /images/MCP/1/1.webp
summary: Tool Calling 개념 설명 & 사용 예제(Qwen3)
---
> 대화형 인공지능은 <strong>"오늘 날씨가 어때?" 라는 질문에</strong> 대답할 수 있을까요?<br>
...
{{<image classes="fig-100 center fancybox" style="width: 400px;" src="/images/MCP/1/1.webp">}}
> 그림 1. Comparison of prompting methods<br>
...
---
#### Reference
Yao, Shunyu (2022) | [ReAct: Synergizing Reasoning and Acting in Language Models](https://arxiv.org/abs/2210.03629)

OpenAI | [Function calling](https://platform.openai.com/docs/guides/function-calling?api-mode=chat)

Qwen3 | [Chat Template](https://huggingface.co/Qwen/Qwen3-32B/blob/main/tokenizer_config.json)
